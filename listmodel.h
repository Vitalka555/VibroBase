...
public:
    /* Перечисляем все роли, которые будут использоваться в TableView
     * Каквидите, они должны лежать в памяти выше параметра Qt::UserRole
     * Связано с тем, что информация ниже этого адреса не для кастомизаций
     * */
    enum Roles {
        IdRole = Qt::UserRole + 1,      // id
...
class ListModelIzmerOpenBI : public QSqlQueryModel
{
    Q_OBJECT
public:
    /* Перечисляем все роли, которые будут использоваться в TableView
    ...
    // объявляем конструктор класса
    explicit ListModelIzmerOpenBI(QObject *parent = 0);
...
public:
    ...
    // объявляем конструктор класса
    explicit ListModelPodsh(QObject *parent = 0);
...
class ListModelOpenPodsh : public QSqlQueryModel
{
    Q_OBJECT
public:
    /* Перечисляем все роли, которые будут использоваться в TableView
    ...
    // объявляем конструктор класса
    explicit ListModelOpenPodsh(QObject *parent = 0);
...
class ListModelRaspPodsh : public QSqlQueryModel
{
    Q_OBJECT
public:
    /* Перечисляем все роли, которые будут использоваться в TableView
    ...
    // объявляем конструктор класса
    explicit ListModelRaspPodsh(QObject *parent = 0);
...
class ListModelTipPodsh : public QSqlQueryModel
{
    Q_OBJECT
public:
    /* Перечисляем все роли, которые будут использоваться в TableView
    ...
    // объявляем конструктор класса
    explicit ListModelTipPodsh(QObject *parent = 0);
