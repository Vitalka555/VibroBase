...
Item {
        ...
        footer: ToolBar {
                ...
                ToolButton {
                    ...
                    onClicked: {
                        ...
                        database.editBearing(tf_name.text, tf_obRU.text, tf_obEN.text, tf_d.text, tf_D.text, tf_B.text,
                                             tf_dtk.text, tf_z.text, tf_u.text, tf_m.text, tf_static.text, tf_dinamic.text, stackView.bearing_id)
    ...
    Component.onCompleted: {
        ...
        mapper_open_podsh.addMapping(tf_name, (0x0100+2), "text")
        mapper_open_podsh.addMapping(tf_obRU, (0x0100+3), "text")
        mapper_open_podsh.addMapping(tf_obEN, (0x0100+4), "text")
        mapper_open_podsh.addMapping(tf_d, (0x0100+5), "text")
        mapper_open_podsh.addMapping(tf_D, (0x0100+6), "text")
        mapper_open_podsh.addMapping(tf_B, (0x0100+7), "text")
        mapper_open_podsh.addMapping(tf_dtk, (0x0100+8), "text")
        mapper_open_podsh.addMapping(tf_z, (0x0100+9), "text")
        mapper_open_podsh.addMapping(tf_u, (0x0100+10), "text")
        mapper_open_podsh.addMapping(tf_m, (0x0100+11), "text")
        mapper_open_podsh.addMapping(tf_static, (0x0100+12), "text")
        mapper_open_podsh.addMapping(tf_dinamic, (0x0100+13), "text")
        tf_d.text = tf_d.text.replace(".", ",")
        tf_D.text = tf_D.text.replace(".", ",")
        tf_B.text = tf_B.text.replace(".", ",")
        tf_dtk.text = tf_dtk.text.replace(".", ",")
